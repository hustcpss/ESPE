...
def do_test_benchmark(time1 = 20 , time2 = 40):
    ...
    for j in range(time2):
        for keyword in keyword_list:
            ...
            find_ret, _ , H_W , _ , r2 = test_SPCHS_mod.Case3EncModCalcAt(keyword_b)
            _ ,transfer =  test_SPCHS_mod.Case3EncPairingAt(Pub , H_W)
            _ = test_SPCHS_mod.Case3EncPairingafterAt(find_ret , r1, r2, g_r1, transfer ,u)
