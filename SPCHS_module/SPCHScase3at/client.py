...
def benchmark(time1 = 20 , time2 = 40):
    time_net = 0.0
    time_cal = 0.0
    ...
    for j in range(time2):
        for keyword in keyword_list:
            ...
            ret1 = test_SPCHS_mod.Case3EncModCalcAt(keyword_b)
            t12 = int(round(time.time()*1000))
            time_cal += t12 - t11
            find_ret, _ , H_W , _ , r2 = ret1
            transfer = pickle.dumps((Pub , H_W))
            ...
            _ , c1 , _ , c2 = test_SPCHS_mod.Case3EncPairingafterAt(find_ret , r1, r2, g_r1, transfer ,u)
